...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
            ...
            <ul id="main-menu" class="main-menu">
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="/MasterList?type=MasterList">
                                <i class="entypo-flow-line"></i>
    ...
    <div class="main-content">
        ...
        {
            //加载模板
            $htmlsource=file_get_contents("E:/wnmp/wwwroot/sandylaravel/public/MasterList.html");
            $htmlsource = mb_convert_encoding( $htmlsource, 'UTF-8', 'UTF-8,GBK,GB2312,BIG5' );
            echo $htmlsource;
        }
        ?>
